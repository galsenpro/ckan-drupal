...
#
#
sudo apt install -y python-pastescript
sudo apt-get install -y build-essential libxml2-dev libxslt-dev wget postgresql libpq-dev git-core python-dev python-psycopg2 python-virtualenv subversion mercurial
